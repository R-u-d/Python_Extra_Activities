...
# Since the introduction of the Gregorian calendar (in 1582), the following rule is 
# used to determine the kind of year:
...
# a warning otherwise: Not within the Gregorian calendar period.
