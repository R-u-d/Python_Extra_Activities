...
# Once upon a time there was a land - a land of milk and honey, inhabited by happy and prosperous
# people. The people paid taxes, of course - their happiness had limits. The most important tax,
# called the Personal Income Tax (PIT for short) had to be paid once a year, and was evaluated
...
# Note: this happy country never returns money to its citizens. If the calculated tax is less
# than zero, it only means no tax at all (the tax is equal to zero). Take this into 
